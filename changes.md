...
- Pressure gradient was inside the RHS calculation this was a problematic 
- Pressure gradient added to intermediate velocity calculation 
...
## RESULTS
- 1.970 for 2nd order IBM  
- 1.109 for Staircase IBM

## NEXT STEPS
- Apply OpenMP 
- Calculate IBM coefficients on GPU